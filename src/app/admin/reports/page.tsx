...
export default async function AdminReportsPage() {
  ...
  const reports = await listPendingReports(admin, { limit: 100 });
              ...
              >
                ...
                {c && (
                  <div className="flex items-center gap-3 flex-wrap pt-1">
                    ...
                    <form
                      action={banCommentAuthorAction.bind(null, c.id, c.post_id)}
                      className="inline-flex items-center gap-1 text-sm"
                    >
                      <span className="text-[color:var(--muted)]">작성자</span>
                      <input
                        name="days"
                        type="number"
                        min={1}
                      ...
                      />
                      <span className="text-[color:var(--muted)]">일 댓글 금지</span>
                      <button
                        type="submit"
